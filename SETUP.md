...
<img src="/assets/aplref_guide_oauth1.png" width=600>
2. Click `New OAuth Application` and fill it in as so:

<img src="/assets/aplref_guide_oauth2.png" width=300>

> [!IMPORTANT]
> The most important part is the `http://localhost:8084` in the `Application Callback URLs`, the client name can be whatever you want.
...
<img src="/assets/aplref_guide_oauth3.png" width=300>

4. Paste in the `Client ID` and `Client Secret` from step 3. into the APL Ref Login Screen.

<img src="/assets/aplref_guide_oauth4.png" width=300>

> [!NOTE]
> The client may ask you to log into osu! as well for authentication afterwards.
